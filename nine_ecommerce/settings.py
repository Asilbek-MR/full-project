...
CLONE_PRJ=['apps.category','apps.product',
...
INSTALLED_APPS = DJANGO_APPS+PROJECT_APPS+CLONE_PRJ+THIRD_PARTY_APPS
...
ROOT_URLCONF = 'nine_ecommerce.urls'
...
WSGI_APPLICATION = 'nine_ecommerce.wsgi.application'
